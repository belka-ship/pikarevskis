...
const projects = [
  ...
  },
  {
    ...
    title: "Skillset",
    description:
      "A Decentralized Physical Infrastructure Network (DePIN) designed to crowdsource training data for autonomous robotics.",
  ...
  },
  {
    ...
    title: "Turtle Hotels",
    description:
      "Next-generation travel agency platform. Blends personalized high-touch service with AI-driven booking efficiency.",
...
const experience = [
  ...
  },
  {
    ...
    role: "Senior Manager",
    impact:
      "Launched Open Hotel API and Marriott's travel management platform.",
  },
  {
    company: "Fora",
    role: "Founding Director of Product",
    impact:
      "Shipped core SaaS platform transacting hundreds of millions in volume.",
  },
  {
    company: "Revolut",
    role: "Product Manager (New Products)",
    impact:
      "Led 0-to-1 launch of Shops, driving $1M+ sales in the first month.",
  },
  {
    company: "Amazon",
...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden md:grid grid-cols-3 gap-8 pb-6 border-b border-gray-800">
            <p className="font-sans text-xs tracking-[0.2em] uppercase text-gray-500">
              Company
            </p>
            <p className="font-sans text-xs tracking-[0.2em] uppercase text-gray-500">
              Role
      ...
      <section
        id="works"
        className="px-6 md:px-12 lg:px-24 py-32 border-t border-gray-100"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            className="mb-24"
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="w-12 h-12 border border-gray-300 rounded-full flex items-center justify-center group-hover:bg-black group-hover:border-black transition-colors duration-150">
                    <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              <blockquote className="font-sans text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed">
                <span className="font-serif text-5xl text-gray-300 leading-none">
                  "
                </span>
                <p className="mt-4">
                  Modern product management requires technical fluency. I
                  leverage AI-augmented workflows to build what I design,
                  instantly closing the loop between user needs and technical
                  execution.
                </p>
              </blockquote>
            </motion.div>
